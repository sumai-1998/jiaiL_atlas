...
import time
from src.ttt3r.dust3r.utils.misc import (
    fill_default_args,
    freeze_all_params,
    is_symmetrized,
    interleave,
...
from src.ttt3r.dust3r.heads import head_factory
from src.ttt3r.dust3r.utils.camera import PoseEncoder
from src.ttt3r.dust3r.patch_embed import get_patch_embed
import dust3r.utils.path_to_croco  # noqa: F401
from src.ttt3r.croco.models.croco import CroCoNet, CrocoConfig  # noqa
from src.ttt3r.dust3r.blocks import (
    Block,
    DecoderBlock,
    Mlp,
    Attention,
...
from src.ttt3r.dust3r.utils.device import to_cpu, to_gpu
...
class ARCroco3DStereo(CroCoNet):
    ...
    def _forward_impl(self, views, ret_state=False):
        ...
        for i in range(len(views)):
            ...
            out_pose_feat_i = dec[-1][:, 0:1] # [1, 1, 768] refined pose token from src.ttt3r.dust3r
            new_mem = self.pose_retriever.update_mem(
                mem, global_img_feat_i, out_pose_feat_i
