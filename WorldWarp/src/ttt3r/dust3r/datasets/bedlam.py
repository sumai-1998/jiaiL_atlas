...
from src.ttt3r.dust3r.datasets.base.base_multiview_dataset import BaseMultiViewDataset
from src.ttt3r.dust3r.utils.image import imread_cv2
...
class BEDLAM_Multi(BaseMultiViewDataset):
    ...
    def _get_views(self, idx, resolution, rng, num_views):
        ...
        for v, view_idx in enumerate(image_idxs):
            ...
            cam_dir = osp.join(osp.join(scene_dir, "cam"))
