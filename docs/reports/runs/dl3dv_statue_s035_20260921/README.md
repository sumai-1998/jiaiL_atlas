> Markdown 归档副本，整理于 2026-09-23。原报告与媒体：[原始文档](../../../../runs/dl3dv_statue_s035_20260921/README.md)。本目录未复制视频或大型资产。
...
[所有场景同时对比视频](../../../../runs/dl3dv_statue_s035_20260921/all_scenes_comparison.mp4)：每行一个场景，左侧是真实帧，右侧是生成帧。225 帧、30 fps、播放时长 7.5 秒；30 fps 是播放速度，不代表原始采集时间。
...
|---|---:|---:|---:|---:|---:|---:|
| 50 | 14.389 | 0.4677 | 0.3842 | 0.0319 | 0.0674 | N/A（单张） |
| 200 | 12.214 | 0.4522 | 0.7804 | 0.1873 | 0.4137 | N/A（单张） |

**FID 限制：**每个端点只有 1 张图，协方差秩至多为 0，数值不稳定，不能用于对照论文 FID 排名。全部新生成帧合并的 FID 也只是诊断，帧之间高度相关。
全部 224 张新生成帧的诊断 FID：115.385。

![逐帧指标](../../../../runs/dl3dv_statue_s035_20260921/metric_curves.png)
...
[并排视频](../../../../runs/dl3dv_statue_s035_20260921/032dee9fb0a8/comparison.mp4) · [生成视频](../../../../runs/dl3dv_statue_s035_20260921/032dee9fb0a8/generated.mp4) · [真实视频](../../../../runs/dl3dv_statue_s035_20260921/032dee9fb0a8/ground_truth.mp4) · [逐帧 CSV](../../../../runs/dl3dv_statue_s035_20260921/032dee9fb0a8/image_metrics.csv)

| 帧 | PSNR↑ | SSIM↑ | LPIPS↓ | R_dist↓ rad | t_dist↓ | GT 视频重建 R / t（估计器参照） |
|---|---:|---:|---:|---:|---:|---:|
| 50 | 14.389 | 0.4677 | 0.3842 | 0.0319 | 0.0674 | 0.0068 / 0.0460 |
| 200 | 12.214 | 0.4522 | 0.7804 | 0.1873 | 0.4137 | 0.0625 / 0.0223 |

![第 50 帧](../../../../runs/dl3dv_statue_s035_20260921/032dee9fb0a8/comparison_frame_050.jpg)

![第 200 帧](../../../../runs/dl3dv_statue_s035_20260921/032dee9fb0a8/comparison_frame_200.jpg)
...
```bash
python scripts/pipelines.py benchmark plan --manifest /data4/sumai/GIL_ATLAS/runs/dl3dv_statue_s035_20260921/selected_manifest.json --count 1 --output runs/NEW_RUN --gpu GPU_ID --camera-intrinsics upstream-mean --camera-source dataset-calibrated --strength 0.35 --geometry-source rolling --audit-guidance
python scripts/pipelines.py benchmark doctor --manifest /data4/sumai/GIL_ATLAS/runs/dl3dv_statue_s035_20260921/selected_manifest.json --count 1 --output runs/NEW_RUN --gpu GPU_ID --camera-intrinsics upstream-mean --camera-source dataset-calibrated --strength 0.35 --geometry-source rolling --audit-guidance
python scripts/pipelines.py benchmark run --manifest /data4/sumai/GIL_ATLAS/runs/dl3dv_statue_s035_20260921/selected_manifest.json --count 1 --output runs/NEW_RUN --gpu GPU_ID --camera-intrinsics upstream-mean --camera-source dataset-calibrated --strength 0.35 --geometry-source rolling --audit-guidance
```
