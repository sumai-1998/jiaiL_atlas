...
@dataclass
class WorldCrafterSchedulerOutput(BaseOutput):
...
class WorldCrafterScheduler(SchedulerMixin, ConfigMixin):
    _compatibles = []
    order = 1
    ...
    def step_euler(
    ...
    ) -> WorldCrafterSchedulerOutput | tuple:
        ...
        return WorldCrafterSchedulerOutput(prev_sample=prev_sample)
    ...
    def step_unipc(
        ...
        return WorldCrafterSchedulerOutput(
